...
- synchronized (简称 同步)的原理 #card #Java并发
  ...
  card-repeats:: 9
  card-ease-factor:: 1.3
  card-next-schedule:: 2024-08-13T09:23:00.950Z
  card-last-reviewed:: 2024-08-13T09:23:00.951Z
  card-last-score:: 3
  ...
  id:: 66544682-54b6-40a8-b0be-a8595a5d199b
	...
	- 偏向锁
		...
		- 如何设置 {{cloze CAS操作,记录线程Id: threadId=this}}
			- ![image.png](../assets/image_1743040608840_0.png)
		- 竞争加剧 {{cloze 膨胀为轻量级锁}}
		- 调用`hashCode()`会**立即撤销**偏向锁,因为偏向锁占用存储hashCode的位置
	- 轻量级锁
		- 栈和锁对象的结构 {{cloze 栈中增加 LockRecord 指向锁对象}} {{cloze 对象头的一部分保存 LockRecord指针}}
			- ![image.png](../assets/image_1743040618870_0.png)
...
- ConcurrentHashMap的原理 #card #Java并发
  ...
  card-repeats:: 4
  card-ease-factor:: 1.3
  card-next-schedule:: 2024-08-13T09:23:07.055Z
  card-last-reviewed:: 2024-08-13T09:23:07.055Z
  card-last-score:: 3
...
- final类 不可变对象 描述 #card #Java并发
  ...
  card-repeats:: 5
  card-ease-factor:: 1.3
  card-next-schedule:: 2024-09-02T03:13:10.357Z
  card-last-reviewed:: 2024-09-02T03:13:10.357Z
  card-last-score:: 3
