...
- Heuristics / Rules 启发式/基于规则
  collapsed:: true
	...
	- ((6655c9ec-f729-47a8-973d-def4459ea2d7))
...
- 查询计划列举
	...
	- 多表join的选择二 -- 枚举各种可能，使用动态规划去缩小范围(选择代价最小的方式)
		- 当>12张表时，Postgres会使用 遗传基因算法去决定（每一步都抛弃耗时最大的方案，对剩余方案进行迭代）不一定找到最好的，但一定不是最差的
- 对嵌套子查询的处理
	- 重写查询语句，将它展平
	- 存储子查询结果到临时表中，DBMS采用这种
-
- 关系代数表达式的等价 Relation Algebra Equivalences
  id:: 6655c9ec-f729-47a8-973d-def4459ea2d7
